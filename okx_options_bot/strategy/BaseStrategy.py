...
from market_data_service.model.Instrument import Instrument, InstState
from market_data_service.model.Tickers import Tickers
from market_data_service.model.MarkPx import MarkPx, MarkPxCache
from position_management_service.model.Positions import Positions
from strategy.params.ParamsLoader import ParamsLoader
from utils.InstrumentUtil import InstrumentUtil
from order_management_service.model.OrderRequest import PlaceOrderRequest, \
    AmendOrderRequest, CancelOrderRequest
from okx.Trade import TradeAPI
from okx.Account import AccountAPI
from settings import *
from db import orders_container, order_books, account_container, positions_container, tickers_container, \
    mark_px_container
from strategy.model.StrategyOrder import StrategyOrder, StrategyOrderStatus
from strategy.model.StrategyMeasurement import StrategyMeasurement
from market_data_service.model.OrderBook import OrderBook
from position_management_service.model.Account import Account
from order_management_service.model.Order import Orders, Order, OrderState, OrderSide
from strategy.risk.RiskCalculator import RiskCalculator
...
from market_data_service.RESTMarketDataService import RESTMarketDataService
from utils.OkxEnum import AccountConfigMode, TdMode, InstType
...
class BaseStrategy(ABC):
    ...
    def __init__(self, api_key, api_key_secret, api_passphrase,
    ...
    @staticmethod
    def get_mark_price() -> MarkPxCache:
        if not mark_px_container:
            raise ValueError(f"mark price information not ready in accounts cache!")
        cache: MarkPxCache = mark_px_container[0]
        return cache
